...
let EventoDetailPageModule = class EventoDetailPageModule {
};
...
let EventoDetailPage = class EventoDetailPage {
    constructor(route, eventoService) {
        this.route = route;
...
EventoDetailPage.ctorParameters = () => [
