...
let EventoService = class EventoService {
    ...
    getEventos() {
        this.eventosCollection = this.db.collection('eventos', ref => ref.orderBy('fechaInicio', 'asc'));
        this.eventos = this.eventosCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(actions => {
    ...
    getTiposEvento() {
        ...
        this.tipoEventos = this.tipoEventosCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(actions => {
            return actions.map(a => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
    ...
    getImagenes(id) {
        ...
        this.imagenEventos = this.imagenEventosCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(actions => {
            return actions.map(a => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
    ...
    getComentarios(id) {
        this.comentariosEventoCollection = this.db.collection('eventos/' + id + '/comentarios', ref => ref.orderBy('fecha', 'desc'));
        this.comentariosEvento = this.comentariosEventoCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(actions => {
            return actions.map(a => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
