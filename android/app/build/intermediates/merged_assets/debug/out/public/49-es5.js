        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var createBaseAnimation = function (pullingRefresherIcon) {
                ...
                var baseAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
                    .duration(1000)
                    .easing('ease-out');
                var spinnerArrowContainerAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
                ...
                var circleInnerAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
                    .addElement(circle)
                    .keyframes([
                ...
                var circleOuterAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
                    .addElement(spinner)
                    .keyframes([
                ...
                if (arrowContainer && arrow) {
                    var arrowContainerAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
                    ...
                    var arrowAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
                        .addElement(arrow)
                        .keyframes([
            ...
            var createScaleAnimation = function (pullingRefresherIcon) {
                ...
                var spinnerAnimation = Object(_animation_0084d55f_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
            ...
            var Refresher = /** @class */ (function () {
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    this.state = state;
                                    if (!(Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this) === 'ios')) return [3 /*break*/, 2];
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["w"])(function () { return ticks.forEach(function (el) { return el.style.setProperty('animation', 'none'); }); });
                                        ...
                                        Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["f"])(function () {
                                            ...
                                            if (scrollTop > 0) {
                                                ...
                                                if (_this.state === 8 /* Refreshing */) {
                                                    var ratio_1 = Object(_helpers_46f4a262_js__WEBPACK_IMPORTED_MODULE_2__["c"])(0, scrollTop / (refresherHeight * 0.5), 1);
                                                    Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["w"])(function () { return setSpinnerOpacity(refreshingSpinner, 1 - ratio_1); });
                                                    return;
                                                }
                                                Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["w"])(function () { return setSpinnerOpacity(pullingSpinner, 0); });
                                                return;
                                            }
                                            ...
                                            var opacity = Object(_helpers_46f4a262_js__WEBPACK_IMPORTED_MODULE_2__["c"])(0, Math.abs(scrollTop) / refresherHeight, 0.99);
                                            var pullAmount = _this.progress = Object(_helpers_46f4a262_js__WEBPACK_IMPORTED_MODULE_2__["c"])(0, (Math.abs(scrollTop) - 30) / MAX_PULL, 1);
                                            var currentTickToShow = Object(_helpers_46f4a262_js__WEBPACK_IMPORTED_MODULE_2__["c"])(0, Math.floor(pullAmount * NUM_TICKS), NUM_TICKS - 1);
                                    ...
                                    _a.gesture = (_b.sent()).createGesture({
                                        ...
                                        onEnd: function () {
                                            ...
                                            if (_this.needsCompletion) {
                                                ...
                                                Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["f"])(function () { return translateElement(_this.elementToTransform, _this.el.clientHeight + "px"); });
                                            }
                                        },
                                    });
                                ...
                                case 1:
                                    _a.gesture = (_b.sent()).createGesture({
                                        ...
                                        onMove: function (ev) {
                                            ...
                                            _this.progress = Object(_helpers_46f4a262_js__WEBPACK_IMPORTED_MODULE_2__["c"])(0, (ev.deltaY / 180) * 0.5, 1);
                                        ...
                                        onEnd: function (ev) {
                                            ...
                                            Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["w"])(function () { return _this.scrollEl.style.removeProperty('--overflow'); });
                                            ...
                                            var progress = Object(_cubic_bezier_1d592096_js__WEBPACK_IMPORTED_MODULE_4__["g"])([0, 0], [0, 0], [1, 1], [1, 1], _this.progress)[0];
                                            var snapBackAnimation = createSnapBackAnimation(pullingRefresherIcon);
                                            _this.animations.push(snapBackAnimation);
                                            Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["w"])(function () { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    ...
                                    if (!shouldUseNativeRefresher(this.el, Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this))) return [3 /*break*/, 2];
                                    this.setupNativeRefresher(contentEl);
                                    return [3 /*break*/, 4];
                                case 2:
                                    _b = this;
                ...
                class_1.prototype.render = function () {
                    ...
                    return (Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["H"], { slot: "fixed", class: (_a = {},
                            _a[mode] = true,
